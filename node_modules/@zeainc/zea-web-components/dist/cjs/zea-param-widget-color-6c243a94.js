...
const iro_es = require('./iro.es-88c8b7c6.js');
...
const ZeaParamWidgetColor = class {
   ...
   */
  setUpColorPicker() {
    this.colorPicker = iro_es.iro$1.ColorPicker(this.colorPickerContainer, {
      ...
      layout: [
        {
          // hue slider
          component: iro_es.iro$1.ui.Slider,
          options: {
            sliderType: 'hue',
          },
        },
...
UxFactory.uxFactory.registerWidget('zea-param-widget-color', (p) => p.getDataType() === 'Color');
