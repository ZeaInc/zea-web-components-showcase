...
const ZeaParamWidgetVec2 = class {
   ...
   */
  render() {
    return (index.h("div", { class: "zea-param-widget-vec2" }, index.h("div", { class: "vector-input-wrap" }, index.h("label", null, "X"), index.h("input", { onInput: this.onInput, onBlur: this.onBlur, ref: (el) => (this.xField = el), id: this.parameter.getName(), type: "number", pattern: "-?[0-9]*(.[0-9]+)?", tabindex: "0", value: this.xValue })), index.h("div", { class: "vector-input-wrap" }, index.h("label", null, "Y"), index.h("input", { onInput: this.onInput, onBlur: this.onBlur, ref: (el) => (this.yField = el), id: this.parameter.getName(), type: "number", pattern: "-?[0-9]*(.[0-9]+)?", tabindex: "0", value: this.yValue }))));
  }
  static get watchers() { return {
    "parameter": ["parameterChangeHandler"]
  }; }
};
UxFactory.uxFactory.registerWidget('zea-param-widget-vec2', (p) => p.getDataType() === 'Vec2');
