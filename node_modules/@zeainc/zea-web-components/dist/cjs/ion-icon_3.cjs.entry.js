...
const ZeaLayout = class {
  ...
  render() {
    ...
    const cellA = (index.h("div", { class: "zea-layout-cell cell-a", style: cellAStyle, ref: (el) => (this.cellA = el) }, this.resizeCellA && (index.h("div", { class: "zea-resize-handle zea-handle-a", onMouseDown: this.handleMouseDown.bind(this), onTouchStart: this.handleMouseDown.bind(this) })), index.h("slot", { name: "a" })));
    const cellB = (index.h("div", { class: "zea-layout-cell cell-b", ref: (el) => (this.cellB = el) }, index.h("slot", { name: "b" })));
    const cellC = this.cellCount > 2 && (index.h("div", { class: "zea-layout-cell cell-c", style: cellCStyle, ref: (el) => (this.cellC = el) }, this.resizeCellC && (index.h("div", { class: "zea-resize-handle zea-handle-c", onMouseDown: this.handleMouseDown.bind(this), onTouchStart: this.handleMouseDown.bind(this) })), index.h("slot", { name: "c" })));
