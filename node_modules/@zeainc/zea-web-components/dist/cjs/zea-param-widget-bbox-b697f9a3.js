...
const ZeaParamWidgetBBox = class {
  ...
  render() {
    ...
    return (index.h("div", { class: "zea-param-widget-bbox" }, index.h("fieldset", null, index.h("legend", null, "Min"), index.h("div", { class: "input-wrap" }, index.h("label", null, "X"), index.h("input", { onInput: this.onInput, onBlur: this.onBlur, id: `${((_a = this === null || this === void 0 ? void 0 : this.parameter) === null || _a === void 0 ? void 0 : _a.getName()) || 'Box3Parameter'}_minX`, ref: (el) => (this.minXField = el), type: "number", pattern: "-?[0-9]*(.[0-9]+)?" })), index.h("div", { class: "input-wrap" }, index.h("label", null, "Y"), index.h("input", { onInput: this.onInput, onBlur: this.onBlur, id: `${((_b = this === null || this === void 0 ? void 0 : this.parameter) === null || _b === void 0 ? void 0 : _b.getName()) || 'Box3Parameter'}_minY`, ref: (el) => (this.minYField = el), type: "number", pattern: "-?[0-9]*(.[0-9]+)?" })), index.h("div", { class: "input-wrap" }, index.h("label", null, "Z"), index.h("input", { onInput: this.onInput, onBlur: this.onBlur, id: `${((_c = this === null || this === void 0 ? void 0 : this.parameter) === null || _c === void 0 ? void 0 : _c.getName()) || 'Box3Parameter'}_minZ`, ref: (el) => (this.minZField = el), type: "number", pattern: "-?[0-9]*(.[0-9]+)?" }))), index.h("fieldset", null, index.h("legend", null, "Max"), index.h("div", { class: "input-wrap" }, index.h("label", null, "X"), index.h("input", { onInput: this.onInput, onBlur: this.onBlur, id: `${((_d = this === null || this === void 0 ? void 0 : this.parameter) === null || _d === void 0 ? void 0 : _d.getName()) || 'Box3Parameter'}_maxX`, ref: (el) => (this.maxXField = el), type: "number", pattern: "-?[0-9]*(.[0-9]+)?" })), index.h("div", { class: "input-wrap" }, index.h("label", null, "Y"), index.h("input", { onInput: this.onInput, onBlur: this.onBlur, id: `${((_e = this === null || this === void 0 ? void 0 : this.parameter) === null || _e === void 0 ? void 0 : _e.getName()) || 'Box3Parameter'}_maxY`, ref: (el) => (this.maxYField = el), type: "number", pattern: "-?[0-9]*(.[0-9]+)?" })), index.h("div", { class: "input-wrap" }, index.h("label", null, "Z"), index.h("input", { onInput: this.onInput, onBlur: this.onBlur, id: `${((_f = this === null || this === void 0 ? void 0 : this.parameter) === null || _f === void 0 ? void 0 : _f.getName()) || 'Box3Parameter'}_maxZ`, ref: (el) => (this.maxZField = el), type: "number", pattern: "-?[0-9]*(.[0-9]+)?" })))));
  }
};
UxFactory.uxFactory.registerWidget('zea-param-widget-bbox', (p) => p.getDataType() === 'Box3');
