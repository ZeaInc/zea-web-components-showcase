...
const ZeaMenuColorpicker = class {
   ...
   */
  render() {
    return (index.h("div", { class: "zea-menu-colorpicker" }, index.h("div", { onClick: this.handleCurrentColorClick.bind(this), class: "currentColor", ref: (el) => (this.currentColorContainer = el) }), index.h("div", { class: `colorDropdown ${this.shown ? 'shown' : ''}`, ref: (el) => (this.dropDownContainer = el) }, index.h("slot", null), this.userColor && (index.h("div", { class: "user-color" }, "My color:", ' ', index.h("zea-menu-color", { ref: (el) => {
