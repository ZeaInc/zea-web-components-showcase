...
export class ZeaParamWidgetVec4 {
   ...
   */
  render() {
    return (h("div", { class: "zea-param-widget-vec4" },
      ...
      h("div", { class: "vector-input-wrap" },
        h("label", null, "Z"),
        h("input", { onInput: this.onInput, onBlur: this.onBlur, ref: (el) => (this.zField = el), id: this.parameter.getName(), type: "number", pattern: "-?[0-9]*(.[0-9]+)?", tabindex: "0", value: this.zValue })),
      h("div", { class: "vector-input-wrap" },
        h("label", null, "T"),
        h("input", { onInput: this.onInput, onBlur: this.onBlur, ref: (el) => (this.tField = el), id: this.parameter.getName(), type: "number", pattern: "-?[0-9]*(.[0-9]+)?", tabindex: "0", value: this.tValue }))));
  }
