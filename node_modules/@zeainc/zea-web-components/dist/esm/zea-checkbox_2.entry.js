...
const ZeaCheckbox = class {
  ...
  render() {
    return (h("div", { class: 'zea-checkbox ' + this.elementClass, onClick: () => {
        this.toggleCheck();
      } }, h("span", { class: "zea-checkbox-wrap" }, h("span", { class: "zea-checkbox-icon" }, !this.isRadio && (h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "100%", height: "100%", viewBox: "0 0 24 24" }, h("path", { class: "icon-path", d: "M9 21.035l-9-8.638 2.791-2.87 6.156 5.874 12.21-12.436 2.843 2.817z" }))), this.isRadio && (h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "100%", height: "100%", viewBox: "0 0 512 512" }, h("path", { class: "icon-path", d: "M256 464c-114.69 0-208-93.31-208-208S141.31 48 256 48s208 93.31 208 208-93.31 208-208 208z" }))))), h("input", { type: "checkbox", name: this.name })));
  }
