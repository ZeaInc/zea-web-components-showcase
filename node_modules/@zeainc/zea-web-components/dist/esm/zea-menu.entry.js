...
const ZeaMenu = class {
   ...
   */
  render() {
    const anchor = this.type == 'contextual' && this.showAnchor ? (h("div", { onMouseUp: this.handleAnchorClick.bind(this), class: "menu-anchor", ref: (el) => (this.anchorElement = el) }, h("zea-icon", { size: this.anchorIconSize, name: this.anchorIcon }))) : null;
    const menuClass = {};
