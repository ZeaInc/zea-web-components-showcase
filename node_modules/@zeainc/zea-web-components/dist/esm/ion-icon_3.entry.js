import { g as getAssetPath, r as registerInstance, h, H as Host, a as getElement } from './index-b00b7e23.js';
...
const ZeaLayout = class {
  ...
  render() {
    ...
    const cellA = (h("div", { class: "zea-layout-cell cell-a", style: cellAStyle, ref: (el) => (this.cellA = el) }, this.resizeCellA && (h("div", { class: "zea-resize-handle zea-handle-a", onMouseDown: this.handleMouseDown.bind(this), onTouchStart: this.handleMouseDown.bind(this) })), h("slot", { name: "a" })));
    const cellB = (h("div", { class: "zea-layout-cell cell-b", ref: (el) => (this.cellB = el) }, h("slot", { name: "b" })));
    const cellC = this.cellCount > 2 && (h("div", { class: "zea-layout-cell cell-c", style: cellCStyle, ref: (el) => (this.cellC = el) }, this.resizeCellC && (h("div", { class: "zea-resize-handle zea-handle-c", onMouseDown: this.handleMouseDown.bind(this), onTouchStart: this.handleMouseDown.bind(this) })), h("slot", { name: "c" })));
...
export { Icon as ion_icon, ZeaIcon as zea_icon, ZeaLayout as zea_layout };
