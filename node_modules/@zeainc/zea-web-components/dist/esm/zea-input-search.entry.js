...
const ZeaInputSearch = class {
  ...
  render() {
    return (h("div", { class: "zea-input-search", ref: (el) => {
        ...
        e.stopPropagation();
      }, class: "zea-input-search-text", type: "text", placeholder: this.placeholder })), h("span", { class: "zea-input-cancel", onClick: () => {
        this.cancelSearch();
      } }, h("svg", { xmlns: "http://www.w3.org/2000/svg", width: "100%", height: "100%", viewBox: "0 0 512 512" }, h("path", { d: "M289.94 256l95-95A24 24 0 00351 127l-95 95-95-95a24 24 0 00-34 34l95 95-95 95a24 24 0 1034 34l95-95 95 95a24 24 0 0034-34z", class: "icon" })))));
  }
  get mainElement() { return getElement(this); }
};
ZeaInputSearch.style = zeaInputSearchCss;

export { ZeaInputSearch as zea_input_search };
