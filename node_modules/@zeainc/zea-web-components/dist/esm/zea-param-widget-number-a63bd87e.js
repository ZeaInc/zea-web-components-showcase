...
const ZeaParamWidgetNumber = class {
  ...
  render() {
    if (this.range) {
      return (h("div", { class: "zea-param-widget-number" }, h("input", { onChange: this.onChange, ref: (el) => (this.inputField = el), class: "mdl-slider mdl-js-slider", type: "range", min: "0", max: "200", step: this.step ? this.step : 1, id: this.parameter.getName(), value: this.value, tabindex: "0" })));
    }
    return (h("div", { class: "zea-param-widget-number" }, h("input", { onChange: this.onChange, ref: (el) => (this.inputField = el), type: "number", pattern: "-?[0-9]*(.[0-9]+)?", id: this.parameter.getName(), value: this.value, tabindex: "0" })));
  }
